...
from .content_helpers import parse_content_id, clean_title

# parse_content_id and clean_title functions are now in utils.content_helpers
# from .content_helpers import parse_content_id, clean_title # This will be used by other modules
